...
#from tracker.neighbortrack import neighbortrack
#from utils.utils import  xy_wh_2_rect
...
class OSTRACK(object):
    ...
    def initialize(self, image, region):
        ...
        self.ntracker.use_neighbor_trajectory=False

        #self.ntracker.del_winner=True
        #self.ntracker.warning_inv_th = 0
        #self.ntracker.test_probe_inv_frames = 1
