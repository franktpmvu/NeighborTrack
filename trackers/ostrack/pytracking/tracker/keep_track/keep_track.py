...
class KeepTrack(BaseTracker):
    ...
    def track(self, image, info: dict = None) -> dict:
        ...
        #print(self.previous_candidates.keys())
        #print(self.previous_candidates['img_coords'])
        #print(self.previous_candidates['tsm_coords'])
        return out
    
    
    def track_neighbor(self, image, info: dict = None) -> dict:
        self.debug_info = {}
    ...
    def cand2bbox(self,cand):
        print(self.params.get('advanced_localization', False))
    ...
    def localize_target_by_candidate_matching(self, im_patches1, backbone_feat1, score_map1, search_area_box1, sample_pos, sample_scales, img_shape):
        ...
        #print(current_candidates['img_coords'])
        #print(current_candidates.keys())
        #print(search_area_box1)# =all search area 
        print(current_candidates['img_coords'])#=center
        print(current_candidates['tsm_coords'])#tsm=grid cell
        print(self.cand2bbox(current_candidates['img_coords']))
